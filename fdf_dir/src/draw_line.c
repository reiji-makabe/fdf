...
/*   Updated: 2023/06/12 17:48:32 by rmakabe          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "map.h"

static void	draw_loop_pos(t_map *p_0, t_data *img, t_draw *draw);
static void	draw_loop_neg(t_map *p_0, t_data *img, t_draw *draw);
...
void	draw_line(t_map *p_0, t_map *p_1, t_data *img)
{
	...
	if (draw.x_and_y_is_pos)
		draw_loop_pos(p_0, img, &draw);
	else
		draw_loop_neg(p_0, img, &draw);
}
